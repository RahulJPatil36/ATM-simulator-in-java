...
public class SignupThree extends JFrame implements ActionListener{
    ...
    SignupThree(String formno){
        ...
        type.setBounds(100,120,400,40);
        add(type);
        
        r1=new JRadioButton("Saving account");
        r1.setFont(new Font("Raleeay",Font.BOLD,16));
        r1.setBackground(Color.white);
        r1.setBounds(380,180,250,20);
        add(r1);
        
        r2=new JRadioButton("Fixed Deposit Account");
        r2.setFont(new Font("Raleeay",Font.BOLD,16));
        r2.setBackground(Color.white);
        r2.setBounds(100,220,250,20);
        add(r2);
         
        r3=new JRadioButton("current account");
        r3.setFont(new Font("Raleeay",Font.BOLD,16));
        r3.setBackground(Color.white);
        r3.setBounds(380,220,250,20);
        add(r3);
        
        r4=new JRadioButton("REccurring Deposit account");
        r4.setFont(new Font("Raleeay",Font.BOLD,16));
        ...
        JLabel number =new JLabel("XXXX-XXXX-XXXX-3636");
        ...
        JLabel services=new JLabel("Services Requrired:");
        ...
        c7=new JCheckBox("I hereby declare that the above enter details correct to the best of my knowledge");
